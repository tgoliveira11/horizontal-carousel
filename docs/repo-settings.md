...
Operational guardrails configured on `tgoliveira11/horizontal-carousel`. These
complement [contributing.md](./contributing.md) and are not fully expressible in
git alone.
