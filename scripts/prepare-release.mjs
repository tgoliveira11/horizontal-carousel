...
/**
 * Release preparation for @tgoliveira/horizontal-carousel (single-package repo).
 *
 * Adapted from the outpost release process. Given a release spec (exact x.y.z,
 * or "patch"/"minor"/"major", or blank/"auto" for changelog-driven inference),
 * it resolves the next version, writes package.json and package-lock.json, and
